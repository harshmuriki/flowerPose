...
class MyHandler:
    ...
    def popup(self):
        ...
        messagebox.showinfo("Reminder", "Update the exposure now!!")
    ...
    def check_camera(self):
        ...
        # self.popup()
        while True:
            ipt = input("Did you readjust the exposure? Enter 'Y' for Yes, or any other key to try again: ")

            if ipt.upper() == "Y":
                print("Setup Done!")
                break
            else:
                print("Setup not working. Trying again")


    def go_around_plant(self, location, radius):
        # Resume from location
        check_z = -300  #Is the min z (-300)
        check_wrist_angle = 0  #0 is original
        check_elbow_angle = 0  #0 is original
        # Resume from location

        min_wrist_angle = 0
        max_wrist_angle = 360
        wrist_step_degree = 20            #EDIT
    ...
    def go_above_plant(self, location, radius):
        ...
        phi_step = 20            #EDIT
        min_phi = -1
        max_phi = 90-phi_step  #90-phi_step orig
    ...
    def go_to_all_plants(self):
        ...
        all_plant_loc = [(331, 771, -200)] #110 is the arm length until the wrist
        ...
        for i, plant_loc in enumerate(all_plant_loc):
            ...
            self.go_above_plant(plant_loc, 300) #all_plant_radius[i]
            old_loc = plant_loc
